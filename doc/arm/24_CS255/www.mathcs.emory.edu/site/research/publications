    ...
    <head>  
	    <title>Department of MATH - Research Area</title>
...
<style>#navbar-li-ele{ border-left:none!important;}</style><nav class="container blue" id="main-nav" role="navigation"><ul><li><a href="/home">Home</a></li><li><a href="/undergraduate">Undergraduate</a></li><li><a href="/graduate">Graduate</a></li><li><a href="/courses">Courses</a></li><li><a class="active" href="/research">Research</a></li><li><a href="/people">People</a></li><li><a href="/events">Events</a></li><li><a href="/about">About</a></li></ul></nav><div class="container"><div class="container" style="background-color:white!important">
    <div class="row col1col2" >
        ...
        <div class="span3" id="context"  style="background-color:white!important;display:table-header-group!important">
            <nav class="gold" id="sub-nav"  role="navigation">
                <ul id="section-nav"><li ><a href='/research/research-areas'  >Research Areas</a></li><li class="selected"><a href='/research/publications'  >Publications</a></li><li ><a href='/events'  >Seminars</a></li><!-- end span3 menu -->   </ul>
            </nav></div> <div class="span9" id="main-content" style="background-color:white!important"><br>
        <h1>Publications</h1>
<p>This page is intended to highlight recent publications by the Mathematics faculty and students. 
</p>
        <a class="btn" href="all">See All Technical Reports</a>
        <h2>Recent Technical Reports:</h2>
...
<footer class="container" id="footer">
    ...
    ©
    <span id="copyright-date">2022</span> 

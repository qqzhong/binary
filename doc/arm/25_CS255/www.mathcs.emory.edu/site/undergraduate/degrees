    ...
    <head>
        ...
        <title>Department of Math/CS - Multiple Choices</title>
...
<body class="classic">
  ...
  <div class="row home-row">
    <div class="component boxed-col-outer span10" style="padding:44px;">
    <h2>The joint department was succeeded by two separate departments.</h2>
    <br>
    <h3 style="color:black">Please visit:</h3>
    <h3 style="margin-left:26px"><a href="https://www.cs.emory.edu/undergraduate/">Department of Computer Science</a></h3>
    <h3 style="margin-left:26px"><a href="https://www.math.emory.edu/undergraduate/">Department of Mathematics</a></h3>
    </div>
  </div>
